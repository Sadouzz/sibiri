...
class Media {
    ...
    createShader() {
      ...
      `,
        ...
        uniform float uObjectFit; // 0 for cover, 1 for contain
        varying vec2 vUv;
...
class App {
    ...
    constructor(
        ...
        this.onResize();
        this.createGeometry();
        this.createMedias(items, bend, textColor, borderRadius, font, planeWidth, planeHeight, objectFit);
        this.update();
...
export default function CircularGallery({
    ...
    }, [items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase, planeWidth, planeHeight, objectFit]);
